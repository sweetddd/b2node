...
func TestConfig(t *testing.T) {
	...
	os.Unsetenv("BITCOIN_BRIDGE_FAUCET_RPC_URL")
	...
	require.Equal(t, "", config.Bridge.FaucetPrivKey)
...
func TestConfigEnv(t *testing.T) {
	...
	os.Setenv("BITCOIN_BRIDGE_FAUCET_PRIV_KEY", "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdee")
	...
	require.Equal(t, "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdee", config.Bridge.FaucetPrivKey)
