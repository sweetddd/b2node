...
// source: zyx/bridge/signer.proto
...
func (*Signer) Descriptor() ([]byte, []int) {
	return fileDescriptor_a04b131d92129177, []int{0}
}
...
func (m *Signer) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func init() {
	proto.RegisterType((*Signer)(nil), "zyx.bridge.Signer")
}

func init() { proto.RegisterFile("zyx/bridge/signer.proto", fileDescriptor_a04b131d92129177) }

var fileDescriptor_a04b131d92129177 = []byte{
	// 172 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x12, 0xaf, 0xaa, 0xac, 0xd0,
	0x4f, 0x2a, 0xca, 0x4c, 0x49, 0x4f, 0xd5, 0x2f, 0xce, 0x4c, 0xcf, 0x4b, 0x2d, 0xd2, 0x2b, 0x28,
	0xca, 0x2f, 0xc9, 0x17, 0xe2, 0xaa, 0xaa, 0xac, 0xd0, 0x83, 0x48, 0x28, 0x25, 0x70, 0xb1, 0x05,
	...
	0x18, 0x35, 0x38, 0x83, 0x60, 0x5c, 0x21, 0x21, 0x2e, 0x96, 0xbc, 0xc4, 0xdc, 0x54, 0x09, 0x66,
	0xb0, 0x30, 0x98, 0x0d, 0x52, 0x9d, 0x5c, 0x94, 0x9a, 0x58, 0x92, 0x5f, 0x24, 0xc1, 0x02, 0x51,
	0x0d, 0xe5, 0x3a, 0xe9, 0x9c, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72,
	0x8c, 0x13, 0x1e, 0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x10,
	0xc8, 0x81, 0x70, 0x27, 0x96, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x9d, 0x68, 0x0c, 0x08,
	0x00, 0x00, 0xff, 0xff, 0x46, 0x74, 0x0c, 0x9e, 0xbd, 0x00, 0x00, 0x00,
}
...
func (m *Signer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintSigner(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Name) > 0 {
		i -= len(m.Name)
		copy(dAtA[i:], m.Name)
		i = encodeVarintSigner(dAtA, i, uint64(len(m.Name)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Address) > 0 {
		...
		i = encodeVarintSigner(dAtA, i, uint64(len(m.Address)))
		i--
		dAtA[i] = 0x12
	}
	if m.Id != 0 {
		i = encodeVarintSigner(dAtA, i, uint64(m.Id))
		i--
		dAtA[i] = 0x8
	}
